namespace Socket
{
    ...
    public partial class HomeWindow : Form
    {
        ...
        public HomeWindow(StorePage inStorePage, CartPage inCartPage, UserPage inUserPage, AdminPage inAdminPage)
        {
            this.InitializeComponent();

            this.storePage = inStorePage;
            this.cartPage = inCartPage;
            this.userPage = inUserPage;
            this.adminPage = inAdminPage;
        ...
        private void SetCartPage()
        {
            ...
            this.cartPage.Width = tabPage2.Width;
        }

...
namespace Socket.Model
{
    ...
    public class Card
    {
        ...
        /// </summary>
        /// <param name="inNumber">Card's number.</param>
        /// <param name="inCode">Card's code.</param>
        /// <param name="inMonth">The month of payment.</param>
        /// <param name="inYear">The year of payment.</param>
        public Card(string inNumber, int inCode, string inMonth, int inYear)
        {
